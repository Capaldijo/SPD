...
\t";
        // line 5
        if (((isset($context["participants"]) ? $context["participants"] : $this->getContext($context, "participants")) == null)) {
            // line 6
...
\t\t\t\t\t\t\t<a href=\"";
            // line 14
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("descartes_evenement_voir", array("id" => (isset($context["id_event"]) ? $context["id_event"] : $this->getContext($context, "id_event")))), "html", null, true);
            echo "\">
...
\t\t\t\t\t\t\t\t\t\t\t";
                // line 22
                if (file_exists((((isset($context["web_path"]) ? $context["web_path"] : $this->getContext($context, "web_path")) . "upload/imageProfil/image_android") . $this->getAttribute((isset($context["particip"]) ? $context["particip"] : $this->getContext($context, "particip")), "id")))) {
                    // line 23
                    echo "\t\t\t\t\t\t\t\t\t\t\t\t<img src=\"";
                    echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl(("upload/imageProfil/image_android" . $this->getAttribute((isset($context["particip"]) ? $context["particip"] : $this->getContext($context, "particip")), "id"))), "html", null, true);
...
\t\t\t\t\t\t\t\t\t \t\t\t<a href=\"";
                // line 32
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("descartes_utilisateur_profil", array("login" => $this->getAttribute((isset($context["particip"]) ? $context["particip"] : $this->getContext($context, "particip")), "username"))), "html", null, true);
                echo "\">
\t\t\t\t\t\t\t\t\t\t\t\t\t";
                // line 33
                echo twig_escape_filter($this->env, twig_capitalize_string_filter($this->env, $this->getAttribute((isset($context["particip"]) ? $context["particip"] : $this->getContext($context, "particip")), "lastname")), "html", null, true);
                echo " ";
                echo twig_escape_filter($this->env, twig_capitalize_string_filter($this->env, $this->getAttribute((isset($context["particip"]) ? $context["particip"] : $this->getContext($context, "particip")), "firstname")), "html", null, true);
                echo "
\t\t\t\t\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t\t \t\t</p>\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t    \t</div> <!--end .info-->
