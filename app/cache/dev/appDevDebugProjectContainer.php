...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'descartes.twig_extension' => 'getDescartes_TwigExtensionService',
            'descartes_recupbd.recupbd' => 'getDescartesRecupbd_RecupbdService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/wamp/www/Sortiesadescartes/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/wamp/www/Sortiesadescartes/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/wamp/www/Sortiesadescartes/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/wamp/www/Sortiesadescartes/app/Resources');
    ...
    /**
     * Gets the 'descartes.twig_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Descartes\UtilisateurBundle\RecupImg\Services\Extension\TwigExtension A Descartes\UtilisateurBundle\RecupImg\Services\Extension\TwigExtension instance.
     */
    protected function getDescartes_TwigExtensionService()
    {
        return $this->services['descartes.twig_extension'] = new \Descartes\UtilisateurBundle\RecupImg\Services\Extension\TwigExtension();
    }

    /**
     * Gets the 'descartes_recupbd.recupbd' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Descartes\RecupbdBundle\Recupbd\Recupbd A Descartes\RecupbdBundle\Recupbd\Recupbd instance.
     */
    protected function getDescartesRecupbd_RecupbdService()
    {
        return $this->services['descartes_recupbd.recupbd'] = new \Descartes\RecupbdBundle\Recupbd\Recupbd();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => '127.0.0.1', 'port' => 5432, 'dbname' => 'SPD_Web', 'user' => 'postgres', 'password' => 'postgresql', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_7eae626f7b12d4d8e6dba229a0b5195a79b99c0d9b56439aad070f80ee5b6ccc');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_7eae626f7b12d4d8e6dba229a0b5195a79b99c0d9b56439aad070f80ee5b6ccc');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_7eae626f7b12d4d8e6dba229a0b5195a79b99c0d9b56439aad070f80ee5b6ccc');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => 'C:\\wamp\\www\\Sortiesadescartes\\src\\Descartes\\UtilisateurBundle\\Entity', 1 => 'C:\\wamp\\www\\Sortiesadescartes\\src\\Descartes\\EvenementBundle\\Entity'));

        $f = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array('C:\\wamp\\www\\Sortiesadescartes\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\doctrine' => 'FOS\\UserBundle\\Entity'));
        $f->setGlobalBasename('mapping');

        $g = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $g->addDriver($e, 'Descartes\\UtilisateurBundle\\Entity');
        $g->addDriver($e, 'Descartes\\EvenementBundle\\Entity');
        $g->addDriver($f, 'FOS\\UserBundle\\Entity');
        $g->addDriver(new \Doctrine\ORM\Mapping\Driver\XmlDriver(new \Doctrine\Common\Persistence\Mapping\Driver\SymfonyFileLocator(array('C:\\wamp\\www\\Sortiesadescartes\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\doctrine\\model' => 'FOS\\UserBundle\\Model'), '.orm.xml')), 'FOS\\UserBundle\\Model');

        $h = new \Doctrine\ORM\Configuration();
        $h->setEntityNamespaces(array('DescartesUtilisateurBundle' => 'Descartes\\UtilisateurBundle\\Entity', 'DescartesEvenementBundle' => 'Descartes\\EvenementBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity'));
        $h->setMetadataCacheImpl($b);
        $h->setQueryCacheImpl($c);
        $h->setResultCacheImpl($d);
        $h->setMetadataDriverImpl($g);
        $h->setProxyDir('C:/wamp/www/Sortiesadescartes/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/wamp/www/Sortiesadescartes/app/Resources');
    }
    ...
    {
        return $this->services['fos_facebook.api'] = new \FOS\FacebookBundle\Facebook\FacebookSessionPersistence(array('appId' => '1468313823386292', 'secret' => 'd2d4d1523226da883bc0049dd57934ec', 'cookie' => true, 'domain' => NULL), $this->get('session'));
    }
    ...
    {
        return $this->services['fos_facebook.helper'] = new \FOS\FacebookBundle\Templating\Helper\FacebookHelper($this->get('templating'), $this->get('fos_facebook.api'), $this->get('router'), true, 'fr_FR', array());
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Descartes\\UtilisateurBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Descartes\\UtilisateurBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Descartes\\UtilisateurBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Descartes\\UtilisateurBundle\\Entity\\Utilisateur');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Descartes\\UtilisateurBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/wamp/www/Sortiesadescartes/app/logs/dev.log', 100, true);
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return Descartes\UtilisateurBundle\Security\User\Provider\FacebookProvider A Descartes\UtilisateurBundle\Security\User\Provider\FacebookProvider instance.
     */
    protected function getMy_Facebook_UserService()
    {
        return $this->services['my.facebook.user'] = new \Descartes\UtilisateurBundle\Security\User\Provider\FacebookProvider($this->get('fos_facebook.api'), $this->get('fos_user.user_manager'), $this->get('validator'));
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/wamp/www/Sortiesadescartes/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/wamp/www/Sortiesadescartes/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/wamp/www/Sortiesadescartes/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Descartes\\UtilisateurBundle\\Entity\\Utilisateur' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $l = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c, 1 => $b), 'helloWorld', 'main', array('name' => 'REMEMBERME', 'lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);

        $m = new \Symfony\Component\Security\Http\Firewall\LogoutListener($d, $k, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($k, '/evenement'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'fos_user_security_logout'));
        $m->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());
        $m->addHandler($l);

        $n = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($k, array('login_path' => '_security_login', 'default_target_path' => '/evenement', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $n->setProviderKey('main');

        $o = new \FOS\FacebookBundle\Security\Firewall\FacebookListener($d, $h, $i, $k, 'main', $n, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($g, $k, array('login_path' => '_security_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('app_url' => 'https://apps.facebook.com/1468313823386292', 'server_url' => 'http://localhost/Symfony/', 'check_path' => '_security_check', 'use_forward' => false, 'require_previous_session' => true, 'display' => 'page', 'create_user_if_not_exists' => false, 'redirect_to_facebook_login' => true), $a, $e);
        $o->setRememberMeServices($l);

        $p = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($k, array('login_path' => 'login', 'default_target_path' => '/evenement', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $p->setProviderKey('main');

        $q = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($d, $h, $i, $k, 'main', $p, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($g, $k, array('login_path' => 'login', 'failure_path' => '/evenement', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => 'login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $e, NULL);
        $q->setRememberMeServices($l);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($j, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($d, array(0 => new \Symfony\Component\Security\Core\User\ChainUserProvider(array(0 => $b, 1 => $c)), 1 => $b, 2 => $c), 'main', $a, $e), 2 => $m, 3 => $o, 4 => $q, 5 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($d, $l, $h, $a, $e), 6 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($d, '5374c0bebf3a9', $a), 7 => new \Symfony\Component\Security\Http\Firewall\AccessListener($d, $this->get('security.access.decision_manager'), $j, $h)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($d, $this->get('security.authentication.trust_resolver'), $k, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($g, $k, 'login', false), NULL, NULL, $a));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/wamp/www/Sortiesadescartes/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/wamp/www/Sortiesadescartes/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/wamp/www/Sortiesadescartes/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/wamp/www/Sortiesadescartes/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'C:/wamp/www/Sortiesadescartes/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/wamp/www/Sortiesadescartes/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));

        $instance->addExtension($this->get('descartes.twig_extension'));
        $instance->addExtension(new \Symfony\Bundle\SecurityBundle\Twig\Extension\LogoutUrlExtension($this->get('templating.helper.logout_url')));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\SecurityExtension($this->get('security.context', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\TranslationExtension($this->get('translator')));
        $instance->addExtension(new \Symfony\Bundle\TwigBundle\Extension\AssetsExtension($this));
        $instance->addExtension(new \Symfony\Bundle\TwigBundle\Extension\ActionsExtension($this));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/wamp/www/Sortiesadescartes/app', 'UTF-8'));
        ...
        $instance->addGlobal('web_path', 'C:/wamp/www/Sortiesadescartes/app/../web/');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\wamp\\www\\Sortiesadescartes\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\wamp\\www\\Sortiesadescartes\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:/wamp/www/Sortiesadescartes/app/Resources/TwigBundle/views', 'Twig');
        $instance->addPath('C:\\wamp\\www\\Sortiesadescartes\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\wamp\\www\\Sortiesadescartes\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\wamp\\www\\Sortiesadescartes\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\wamp\\www\\Sortiesadescartes\\src\\Descartes\\UtilisateurBundle/Resources/views', 'DescartesUtilisateur');
        $instance->addPath('C:\\wamp\\www\\Sortiesadescartes\\src\\Descartes\\EvenementBundle/Resources/views', 'DescartesEvenement');
        $instance->addPath('C:\\wamp\\www\\Sortiesadescartes\\src\\Descartes\\RechercheBundle/Resources/views', 'DescartesRecherche');
        $instance->addPath('C:\\wamp\\www\\Sortiesadescartes\\src\\Descartes\\RecupbdBundle/Resources/views', 'DescartesRecupbd');
        $instance->addPath('C:\\wamp\\www\\Sortiesadescartes\\vendor\\friendsofsymfony\\facebook-bundle\\FOS\\FacebookBundle/Resources/views', 'FOSFacebook');
        $instance->addPath('C:\\wamp\\www\\Sortiesadescartes\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/views', 'FOSUser');
        $instance->addPath('C:\\wamp\\www\\Sortiesadescartes\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\wamp\\www\\Sortiesadescartes\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/wamp/www/Sortiesadescartes/app/Resources/views');
        $instance->addPath('C:\\wamp\\www\\Sortiesadescartes\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('helloWorld');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/wamp/www/Sortiesadescartes/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/wamp/www/Sortiesadescartes/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['security.user.provider.concrete.main'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'Descartes\\UtilisateurBundle\\Entity\\Utilisateur', 'username', NULL);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/wamp/www/Sortiesadescartes/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'C:\\wamp\\www\\Sortiesadescartes\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml', 1 => 'C:\\wamp\\www\\Sortiesadescartes\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation.xml', 2 => 'C:\\wamp\\www\\Sortiesadescartes\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation\\orm.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/wamp/www/Sortiesadescartes/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/wamp/www/Sortiesadescartes/app/cache/dev',
            'kernel.logs_dir' => 'C:/wamp/www/Sortiesadescartes/app/logs',
            'kernel.bundles' => array(
                ...
                'DescartesUtilisateurBundle' => 'Descartes\\UtilisateurBundle\\DescartesUtilisateurBundle',
                'DescartesEvenementBundle' => 'Descartes\\EvenementBundle\\DescartesEvenementBundle',
                'DescartesRechercheBundle' => 'Descartes\\RechercheBundle\\DescartesRechercheBundle',
                'DescartesRecupbdBundle' => 'Descartes\\RecupbdBundle\\DescartesRecupbdBundle',
            ...
            'locale' => 'fr',
            'secret' => 'helloWorld',
            'web_path' => 'C:/wamp/www/Sortiesadescartes/app/../web/',
            ...
            'debug.container.dump' => 'C:/wamp/www/Sortiesadescartes/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'kernel.secret' => 'helloWorld',
            ...
            'session.save_path' => 'C:/wamp/www/Sortiesadescartes/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'C:\\wamp\\www\\Sortiesadescartes\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
                1 => 'C:\\wamp\\www\\Sortiesadescartes\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation.xml',
                2 => 'C:\\wamp\\www\\Sortiesadescartes\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation\\orm.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:C:/wamp/www/Sortiesadescartes/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/wamp/www/Sortiesadescartes/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/wamp/www/Sortiesadescartes/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/wamp/www/Sortiesadescartes/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/wamp/www/Sortiesadescartes/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/wamp/www/Sortiesadescartes/app/../web',
            'assetic.write_to' => 'C:/wamp/www/Sortiesadescartes/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/wamp/www/Sortiesadescartes/app/cache/dev/doctrine/orm/Proxies',
            ...
            'fos_facebook.app_id' => '1468313823386292',
            'fos_facebook.secret' => 'd2d4d1523226da883bc0049dd57934ec',
            'fos_facebook.cookie' => true,
            'fos_facebook.domain' => NULL,
            'fos_facebook.logging' => true,
            'fos_facebook.culture' => 'fr_FR',
            ...
            'fos_user.model.user.class' => 'Descartes\\UtilisateurBundle\\Entity\\Utilisateur',
