 ...
 */
class Image extends \Descartes\UtilisateurBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function upload($userId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'upload', array($userId));

        return parent::upload($userId);
    }
