...
\t\t<form id=\"profilTableMain\" action=\"";
        // line 12
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("descartes_evenement_setting", array("id" => (isset($context["id_event"]) ? $context["id_event"] : null))), "html", null, true);
        echo "\" method=\"post\" ";
